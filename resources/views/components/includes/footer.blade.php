...
<footer
   class="relative z-10 bg-gray-50 pt-20 pb-10 lg:pt-[120px] lg:pb-20"
   >
         ...
         <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div class="w-full mb-10">
               <a
                  ...
                  >
               <h1 class="text-dark text-xl font-semibold">Creative Himel</h1>
               </a>
               <p class="text-base text-body-color text-dark mb-7">
                  Sed ut perspiciatis undmnis is iste natus error sit amet
                  voluptatem totam rem aperiam.
               </p>
               <p
                  class="flex items-center text-sm font-medium text-dark mb-7"
                  >
            ...
            <div class="w-full mb-10">
               ...
               <ul class="space-y-3">
                  <li>
                     <a
                        href="javascript:void(0)"
                        class="inline-block text-base leading-loose text-body-color hover:text-indigo-500 dark:text-dark-6"
                        >
                     SaaS Development
                     </a>
                  </li>
         ...
         <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div class="w-full mb-10">
               ...
               <div class="flex items-center mb-6">
                  <a
                     href="javascript:void(0)"
                     class="flex items-center justify-center w-8 h-8 mr-3 border rounded-full text-dark hover:border-indigo-500 hover:bg-indigo-500 border-stroke dark:border-dark-3 dark:hover:border-indigo-500 text-indigo-400 hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                     >
                     <svg
                        width="8"
                        height="16"
