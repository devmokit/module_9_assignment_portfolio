...
<section
    id="about"
   class="overflow-hidden pt-20 pb-12 lg:pt-[120px] lg:pb-[90px] bg-white"
   >
      ...
      <div class="flex flex-wrap items-center justify-between -mx-4">
         ...
         <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div class="mt-10 lg:mt-0">
               <span class="block mb-4 text-lg font-semibold text-indigo-500">
               Why Choose Us
               </span>
               <h2
               ...
               <a
                  ...
                  class="inline-flex items-center justify-center py-3 text-base font-medium text-center text-white border border-transparent rounded-md px-7 bg-indigo-500 hover:bg-opacity-90"
                  >
               Get Started
               </a>
            </div>
