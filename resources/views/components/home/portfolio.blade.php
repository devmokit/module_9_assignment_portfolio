...
id="project"
   ...
   inactiveClasses: 'text-body-color dark:text-dark-6 hover:bg-primary hover:text-indigo-500',
   }
   "
         ...
         <div
            ...
            <div class="relative mb-12">
               ...
               <div
                  ...
                  >
                  <span class="text-dark mb-2 block text-sm font-medium">
                  Branding
                  </span>
                  ...
                  <a
                     ...
                     class="text-body-color dark:text-dark-6 hover:border-primary hover:bg-primary inline-block rounded-md border border-stroke dark:border-dark-3 py-[10px] px-7 text-sm font-medium transition hover:text-indigo-500"
                     >
                  View Details
                  </a>
               </div>
